...
<head>
    ...
    @vite(['resources\css\sb-admin-2.css', 'resources\css\sb-admin-2.min.css', 'resources\vendor/fontawesome-free/css/all.min.css'])
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">{{ Auth::user()->name }} <sup>gg</sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Products in Store</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{App\Models\product::count()}}</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa-brands fa-product-hunt  fa-2x text-gray-300"></i>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            @vite(['resources\vendor/jquery/jquery.min.js', 'resources\vendor/bootstrap/js/bootstrap.bundle.min.js', 'resources\vendor/jquery-easing/jquery.easing.min.js', 'resources\js/sb-admin-2.min.js', 'resources\vendor/chart.js/Chart.min.js', 'resources\js/demo/chart-area-demo.js', 'resources\js/demo/chart-pie-demo.js'])
